...
-- Este script é idêntico ao script common, mas aplicado ao banco de testes

-- EMPRESTIMO_DEVOLUCAO_ITEM_AUD
DO $$ BEGIN IF NOT EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name = 'emprestimo_devolucao_item_aud' AND column_name = 'status_devolucao_mod') THEN
    IF EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name = 'emprestimo_devolucao_item_aud' AND column_name = 'status_mod') THEN ALTER TABLE emprestimo_devolucao_item_aud RENAME COLUMN status_mod TO status_devolucao_mod;
    ELSE ALTER TABLE emprestimo_devolucao_item_aud ADD COLUMN status_devolucao_mod BOOLEAN; END IF; END IF; END $$;
DO $$ BEGIN IF NOT EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name = 'emprestimo_devolucao_item_aud' AND column_name = 'item_mod') THEN
    IF EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name = 'emprestimo_devolucao_item_aud' AND column_name = 'item_id_mod') THEN ALTER TABLE emprestimo_devolucao_item_aud RENAME COLUMN item_id_mod TO item_mod;
    ELSE ALTER TABLE emprestimo_devolucao_item_aud ADD COLUMN item_mod BOOLEAN; END IF; END IF; END $$;
DO $$ BEGIN IF NOT EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name = 'emprestimo_devolucao_item_aud' AND column_name = 'emprestimo_mod') THEN
    IF EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name = 'emprestimo_devolucao_item_aud' AND column_name = 'emprestimo_id_mod') THEN ALTER TABLE emprestimo_devolucao_item_aud RENAME COLUMN emprestimo_id_mod TO emprestimo_mod;
    ELSE ALTER TABLE emprestimo_devolucao_item_aud ADD COLUMN emprestimo_mod BOOLEAN; END IF; END IF; END $$;

-- EMPRESTIMO_ITEM_AUD
DO $$ BEGIN IF NOT EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name = 'emprestimo_item_aud' AND column_name = 'item_mod') THEN
    IF EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name = 'emprestimo_item_aud' AND column_name = 'item_id_mod') THEN ALTER TABLE emprestimo_item_aud RENAME COLUMN item_id_mod TO item_mod;
    ELSE ALTER TABLE emprestimo_item_aud ADD COLUMN item_mod BOOLEAN; END IF; END IF; END $$;
DO $$ BEGIN IF NOT EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name = 'emprestimo_item_aud' AND column_name = 'emprestimo_mod') THEN
    IF EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name = 'emprestimo_item_aud' AND column_name = 'emprestimo_id_mod') THEN ALTER TABLE emprestimo_item_aud RENAME COLUMN emprestimo_id_mod TO emprestimo_mod;
    ELSE ALTER TABLE emprestimo_item_aud ADD COLUMN emprestimo_mod BOOLEAN; END IF; END IF; END $$;

-- EMPRESTIMO_AUD
DO $$ BEGIN IF NOT EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name = 'emprestimo_aud' AND column_name = 'usuario_responsavel_mod') THEN
    IF EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name = 'emprestimo_aud' AND column_name = 'usuario_responsavel_id_mod') THEN ALTER TABLE emprestimo_aud RENAME COLUMN usuario_responsavel_id_mod TO usuario_responsavel_mod;
    ELSE ALTER TABLE emprestimo_aud ADD COLUMN usuario_responsavel_mod BOOLEAN; END IF; END IF; END $$;
DO $$ BEGIN IF NOT EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name = 'emprestimo_aud' AND column_name = 'usuario_emprestimo_mod') THEN
    IF EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name = 'emprestimo_aud' AND column_name = 'usuario_emprestimo_id_mod') THEN ALTER TABLE emprestimo_aud RENAME COLUMN usuario_emprestimo_id_mod TO usuario_emprestimo_mod;
    ELSE ALTER TABLE emprestimo_aud ADD COLUMN usuario_emprestimo_mod BOOLEAN; END IF; END IF; END $$;

-- Add missing collection mod columns for Emprestimo
DO $$ BEGIN IF NOT EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name = 'emprestimo_aud' AND column_name = 'emprestimo_item_mod') THEN
    ALTER TABLE emprestimo_aud ADD COLUMN emprestimo_item_mod BOOLEAN; END IF; END $$;
DO $$ BEGIN IF NOT EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name = 'emprestimo_aud' AND column_name = 'emprestimo_devolucao_item_mod') THEN
    ALTER TABLE emprestimo_aud ADD COLUMN emprestimo_devolucao_item_mod BOOLEAN; END IF; END $$;

-- ITEM_AUD
DO $$ BEGIN IF NOT EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name = 'item_aud' AND column_name = 'grupo_mod') THEN
    IF EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name = 'item_aud' AND column_name = 'grupo_id_mod') THEN ALTER TABLE item_aud RENAME COLUMN grupo_id_mod TO grupo_mod;
    ELSE ALTER TABLE item_aud ADD COLUMN grupo_mod BOOLEAN; END IF; END IF; END $$;

-- Add missing collection mod column for Item
DO $$ BEGIN IF NOT EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name = 'item_aud' AND column_name = 'image_item_mod') THEN
    ALTER TABLE item_aud ADD COLUMN image_item_mod BOOLEAN; END IF; END $$;
