...
<div>
    <div class="article">
        ...
        <br/><br/>
        <p>Seu empréstimo foi realizado com sucesso no dia ${dtEmprestimo}.</p>
        <br/>
        ...
        <br/>
        <p>O(s) iten(s) emprestados são permanentes, logo não será necessário efetuar a devolação do(s) mesmo(s).</p>
        <br/><br/>
        <p>Att,</p>
