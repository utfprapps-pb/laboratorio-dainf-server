...
public class EmprestimoFilterRepositoryImpl implements EmprestimoFilterRepository {
  ...
  public List<Emprestimo> filter(EmprestimoFilter emprestimoFilter) {
    ...
    List<Emprestimo> toReturn =
        jdbcTemplate.query(sql, params, new BeanPropertyRowMapper<>(Emprestimo.class));
    setUsuarioOnEmprestimo(toReturn);
    return toReturn;
  }

  private void setUsuarioOnEmprestimo(List<Emprestimo> emprestimoList) {
    emprestimoList.forEach(
        emprestimo -> {
          String sql =
          ...
          Usuario usuario =
              jdbcTemplate.queryForObject(sql, params, new BeanPropertyRowMapper<>(Usuario.class));
  ...
  private void setPermissaoUsuario(Usuario usuario) {
    ...
    List<Permissao> p =
        jdbcTemplate.query(sql, params, new BeanPropertyRowMapper<>(Permissao.class));
