package br.com.utfpr.gerenciamento.server.minio.service.impl;
...
import br.com.utfpr.gerenciamento.server.minio.util.MinioUtil;
...
public class MinioServiceImpl implements MinioService {
    ...
    public FileResponse putObject(MultipartFile multipartFile,
        ...
        try {
            ...
            log.error("MinioServiceImpl - putObject - Message: ".concat(e.getMessage()));
            return null;
        }
    }
