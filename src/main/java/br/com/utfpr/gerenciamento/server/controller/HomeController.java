...
public class HomeController {
  ...
  public List<DashboardEmprestimoDia> findDadosEmprestimoByDayRange(
      @RequestParam("dtIni") String dtIni, @RequestParam("dtFim") String dtFim) {
  ...
  public List<DashboardItensAdquiridos> findItensMaisAdquiridos(
      @RequestParam("dtIni") String dtIni, @RequestParam("dtFim") String dtFim) {
  ...
  public List<DashboardItensSaidas> findItensMaisSaidas(
      @RequestParam("dtIni") String dtIni, @RequestParam("dtFim") String dtFim) {
